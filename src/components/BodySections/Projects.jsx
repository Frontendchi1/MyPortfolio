    ...
    >
      <div className=" bg-black/50 relative rounded text-xl text-white cursor-pointer">
        ...
        >
         ...
         <p className="text-center mt-40 text-amber-400 font-bold">Picture Searching Site </p> 
          {isHovered && (
            <div className="card-overlay absolute top-0 left-0 w-full h-full bg-black/50 backdrop-blur-sm flex flex-col items-center justify-center gap-5 opacity-0">
              ...
              <div className="links flex items-center justify-center gap-5">
                <a
                  ...
                  href=" https://marvelous-seahorse-607c81.netlify.app"
                  target="_blank"
                ...
                <a
                  className="card-button p-3 rounded-lg bg-green-600 font-semibold flex gap-2 items-center  hover:bg-amber-400 hover:text-black"
                  href="https://github.com/Frontendchi1/photo-searching.git"
                  target="_blank"
                  rel="noopener noreferrer"
                >
      ...
      <div className=" bg-black/50 relative rounded text-xl text-white cursor-pointer">
        ...
        >
          <div className="card-image absolute top-0 left-0 w-full h-full" />
          <p className="text-center mt-40 text-amber-400 font-bold"> Crud site </p> 
          {isHovered && (
            <div className="card-overlay absolute top-0 left-0 w-full h-full bg-black/50 backdrop-blur-sm flex flex-col items-center justify-center gap-5 opacity-0">
              <div className="font-bold">
                Crud Site
              ...
              <div className="links flex items-center justify-center gap-5">
                <a
                  className="card-button p-3 rounded-lg bg-green-600 font-semibold flex gap-2 items-center hover:bg-amber-400 hover:text-black"
                  href=" https://dancing-snickerdoodle-6fdc1c.netlify.app"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FontAwesomeIcon icon={faEye} />
                ...
                <a
                  className="card-button p-3 rounded-lg bg-green-600 font-semibold flex gap-2 items-center  hover:bg-amber-400 hover:text-black"
                  href="https://github.com/Frontendchi1/Crud.git"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FontAwesomeIcon icon={faCode} />
      ...
      <div className=" bg-black/50 relative rounded text-xl text-white cursor-pointer">
        ...
        >
          <div className="card-image absolute top-0 left-0 w-full h-full" />
          <p className="text-center mt-40 text-amber-400 font-bold"> Comfy Store </p>
          {isHovered && (
            <div className="card-overlay absolute top-0 left-0 w-full h-full bg-black/50 backdrop-blur-sm flex flex-col items-center justify-center gap-5 opacity-0">
              <div className="font-bold">
                Comfy Store
              ...
              <div className="links flex items-center justify-center gap-5">
                ...
                <a
                  className="card-button p-3 rounded-lg bg-green-600 font-semibold flex gap-2 items-center  hover:bg-amber-400 hover:text-black"
                  href="https://github.com/Frontendchi1/comfy-store.git"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FontAwesomeIcon icon={faCode} />
