...
import { faCodeMerge, faLaptopCode, faUserSecret } from "@fortawesome/free-solid-svg-icons";
import { faDev, faPinterest } from "@fortawesome/free-brands-svg-icons";
  ...
  return (
    <div className="navBar sticky top-0 w-full flex justify-between px-12 py-5 bg-black text-amber-400">
      <div className=" text-3xl flex gap-2 text-black-400">
        ...
        />
        <span className="font-bold font-dancingScript">{"<Coder Girl/>"} </span>
      </div>
